  ...
  const inner = (
    <div className="relative h-[300px] sm:h-[310px] md:h-[350px] lg:h-[400px] xl:h-[440px]">
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-4 text-white sm:p-8 lg:p-9 xl:p-10">
        ...
        <span className="mt-4 w-fit rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-[#1A2235] shadow-sm transition group-hover:bg-[#FF6B35] group-hover:text-white md:mt-5 lg:px-6 lg:py-3 lg:text-base">
          {deal.cta}
        </span>
      </div>
    </div>
